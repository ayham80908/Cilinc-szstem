...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle"> المرضى | تعديل بيانات مريض</h1>
</div>
<ol class="breadcrumb">
<li>
<span>المرضى</span>
...
<h5 class="panel-title">تعديل بيانات المريض</h5>
</div>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="Female" checked="true"> أنثى
              <input type="radio" name="gender" id="gender" value="male">ذكر
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true"> ذكر
              <input type="radio" name="gender" id="gender" value="Female">  أنثى 
              </label>
             <?php } ?>
            </div>
<div class="form-group">
